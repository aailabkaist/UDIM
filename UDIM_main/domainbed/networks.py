...
class MappingNetwork(torch.nn.Module):
    def __init__(self, depth=5):
        ...
        for i in range(depth):
            ...
            # self.weight1.append(nn.Parameter(torch.ones((256,56,56))))
            # self.bias1.append(nn.Parameter(torch.zeros((256,56,56))))
            #
            # self.weight2.append(nn.Parameter(torch.ones((512,28,28))))
            # self.bias2.append(nn.Parameter(torch.zeros((512,28,28))))
            #
            # self.weight3.append(nn.Parameter(torch.ones((1024,14,14))))
            # self.bias3.append(nn.Parameter(torch.zeros((1024,14,14))))
            #
            # self.weight4.append(nn.Parameter(torch.ones((2048, 7, 7))))
            # self.bias4.append(nn.Parameter(torch.zeros((2048, 7, 7))))
