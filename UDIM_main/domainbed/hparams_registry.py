...
def _hparams(algorithm, dataset, random_state):
    ...
    if dataset not in SMALL_IMAGES:
        ...
        if algorithm == 'ITTA' or algorithm == 'RIDG':
    ...
    if algorithm in ["DANN", "CDANN"]:
        ...
        hparams['momentum'] = (0.001, 10 ** random_state.uniform(-4, -1))
        hparams['ridg_reg'] = (0.01, 10 ** random_state.uniform(-2, -1))

    elif algorithm == 'ITTA':
        if dataset == 'DomainNet':
            hparams['ada_lr'] = (0.1,10**random_state.uniform(-1, -1))
        else:
            hparams['ada_lr'] = (1e-6, 10**random_state.uniform(-6, -6))
    elif algorithm == "RSC":
    ...
    elif algorithm == "IADA_DG":
        hparams["rho"] = (0.05, random_state.choice([0.01, 0.02, 0.05, 0.1]))
        hparams["alpha"] = (0.001, random_state.choice([0.01, 0.02, 0.05, 0.1]))
        hparams["rho_s"] = (0.05, random_state.choice([0.01, 0.02, 0.05, 0.1]))
    elif algorithm == "IADA_DG_FINAL":
        hparams["rho"] = (0.05, random_state.choice([0.01, 0.02, 0.05, 0.1]))
        hparams["alpha"] = (0.001, random_state.choice([0.01, 0.02, 0.05, 0.1]))
        hparams["rho_s"] = (0.05, random_state.choice([0.01, 0.02, 0.05, 0.1]))
        if dataset not in SMALL_IMAGES:
